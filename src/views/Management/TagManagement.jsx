...
export default function TagManagement({
  ...
  const onSubmit = async (e) => {
    ...
    const error = await handleCreateTag(newTagName.trim());
      ...
      <div className="page-inner max-w-2xl mx-auto space-y-12 pb-32 pt-4 md:pt-0 px-6">
        ...
        <div className="space-y-12 fade-in">
          ...
          <section className="space-y-6 pt-10">
            ...
            <form onSubmit={onSubmit} className="bg-surface-low p-10 rounded-[3rem] border border-outline-variant/10 shadow-2xl space-y-8">
